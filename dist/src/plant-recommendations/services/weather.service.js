...
const linear_regression_1 = require("../../utils/math/linear-regression/linear-regression");
...
durationMonths = 3 // Duration of the prediction period (default: 3 months)
    ...
    const tempRegression = (0, linear_regression_1.safeLinearRegression)(temperatureYears, temperatures);
    const lastTemperatureYear = Math.max(...temperatureYears); // Find the latest year
    // Perform linear regression for precipitation
    const precipRegression = (0, linear_regression_1.safeLinearRegression)(precipitationYears, precipitations);
